...
namespace Lean.Touch
{
	...
	public class LeanRotate : MonoBehaviour
	{
		...
		protected virtual void TranslateUI(float twistDegrees, Vector3 twistScreenCenter)
		{
			...
			var screenDelta   = twistRotation * ((Vector3)screenPoint - twistScreenCenter);

			screenPoint.x = twistScreenCenter.x + screenDelta.x;
			screenPoint.y = twistScreenCenter.y + screenDelta.y;
            //screenPoint.z = twistScreenCenter.z + screenDelta.z;
		...
		protected virtual void Translate(float twistDegrees, Vector3 twistScreenCenter)
		{
			...
			if (camera != null)
			{
                ...
                screenPoint.x = twistScreenCenter.y + screenDelta.y;
                screenPoint.z = twistScreenCenter.z + screenDelta.z;
